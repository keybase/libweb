...
(function() {
  ...
  exports.Config = Config = (function() {
    function Config(_arg) {
      this.request = _arg.request, this.C = _arg.C, this.fq_api_endpoint = _arg.fq_api_endpoint, this.escape_user_content = _arg.escape_user_content;
    }
    ...
    Config.prototype.request = function(args, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this.request.request(args, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                err = arguments[0];
