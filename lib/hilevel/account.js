...
(function() {
  var Account, KeyManager, WordArray, athrow, bufsplit, iced, kbpgp, make_esc, triplesec, xor_buffers, __iced_k, __iced_k_noop;
  ...
  exports.Account = Account = (function() {
    ...
    Account.prototype._cpp2_encrypt_lks_client_half = function(_arg, cb) {
      var client_half, deviceid, esc, key_role, keys, kid, km, me, ret, ___iced_passed_deferral, __iced_deferrals, __iced_k, _next;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    Account.prototype._cpp2_reencrypt_pgp_private_keys = function(_arg, cb) {
      var bundle, esc, km, me, new_ppc, old_ppc, output, outputs, passphrase_generation, tsenc, ___iced_passed_deferral, __iced_deferrals, __iced_k, _next;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
        ...
        return (function(__iced_k) {
          ...
          _while = function(__iced_k) {
            ...
            if (!(_i < _len)) {
              ...
              bundle = _ref[_i].bundle;
              (function(__iced_k) {
                __iced_deferrals = new iced.Deferrals(__iced_k, {
                  parent: ___iced_passed_deferral,
                  filename: "/Users/max/src/keybase/libweb/src/hilevel/account.iced",
                  funcname: "Account._cpp2_reencrypt_pgp_private_keys"
                });
                KeyManager.import_from_p3skb({
                  armored: bundle
                }, esc(__iced_deferrals.defer({
    ...
    Account.prototype.change_passphrase = function(_arg, cb) {
      var esc, lks_mask, lksch, me, new_pp, new_ppc, old_pp, old_ppc, params, private_keys, res, salt, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
              ...
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  (function(__iced_k) {
                    ...
                    _this._cpp2_reencrypt_pgp_private_keys({
                      me: me,
                      old_ppc: old_ppc,
                      new_ppc: new_ppc
                    }, esc(__iced_deferrals.defer({
