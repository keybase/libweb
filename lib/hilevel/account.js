...
(function() {
  var Account, KeyManager, WordArray, bufsplit, burn, iced, kbpgp, make_esc, triplesec, __iced_k, __iced_k_noop;
  ...
  KeyManager = kbpgp.KeyManager, burn = kbpgp.burn;
  ...
  exports.Account = Account = (function() {
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            return cb(err, pwh, pwh_version, salt, typeof body !== "undefined" && body !== null ? body.login_session : void 0);
          });
        };
      })(this));
    };
    ...
    Account.prototype.change_passphrase = function(oldpw, newpw, cb) {
      var body, endpoint, esc, params, salt, sk, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      params = {};
              ...
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  _this.config.request({
                    method: "POST",
                    endpoint: endpoint
                  }, params, esc(__iced_deferrals.defer({
                    assign_fn: (function() {
                      return function() {
