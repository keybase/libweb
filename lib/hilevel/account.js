...
(function() {
  ...
  exports.Account = Account = (function() {
    ...
    Account.prototype._cpp2_reencrypt_pgp_private_key = function(_arg, cb) {
      var esc, key, km, me, new_ppc, old_ppc, output, passphrase_generation, tsenc, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    Account.prototype.change_passphrase_v2 = function(_arg, cb) {
      var esc, lks_mask, lksch, me, new_pp, new_ppc, old_pp, old_ppc, params, private_key, res, salt, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
