...
(function() {
  var Account, KeyManager, WordArray, athrow, bufsplit, generate_pdpka, iced, kbpgp, make_esc, myslice, proofs, secret32_to_signing_kid, secret32_to_signing_km, to_user, triplesec, xor_buffers, __iced_k, __iced_k_noop,
  ...
  exports.Account = Account = (function() {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/michal/libweb/src/hilevel/account.iced",
    ...
    Account.prototype.pw_to_login = function(_arg, cb) {
      var email_or_username, esc, hmac_pwh, hostname, login_session, login_session_b64, pdpka4, pdpka4_km, pdpka5, pdpka5_km, pw, pwh, pwh_version, salt, uid, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      pw = _arg.pw, email_or_username = _arg.email_or_username, hostname = _arg.hostname, uid = _arg.uid;
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            _this.pwh_to_login_params({
              hostname: hostname,
              login_session_b64: login_session_b64,
              pwh: pwh,
              email_or_username: email_or_username,
              uid: uid,
              pdpka5_km: pdpka5_km,
              ...
              assign_fn: (function() {
                return function() {
                  login_session = arguments[0].login_session;
                  hmac_pwh = arguments[0].hmac_pwh;
                  pdpka4 = arguments[0].pdpka4;
                  return pdpka5 = arguments[0].pdpka5;
                };
              })(),
              lineno: 149
            })));
    ...
    Account.prototype.pwh_to_login_params = function(_arg, cb) {
      var email_or_username, esc, hmac, hmac_pwh, hostname, login_session, login_session_b64, pdpka4, pdpka4_km, pdpka5, pdpka5_km, pwh, session, uid, user, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      hostname = _arg.hostname, login_session_b64 = _arg.login_session_b64, pwh = _arg.pwh, email_or_username = _arg.email_or_username, uid = _arg.uid, pdpka4_km = _arg.pdpka4_km, pdpka5_km = _arg.pdpka5_km;
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/home/michal/libweb/src/hilevel/account.iced",
            funcname: "Account.pwh_to_login_params"
          });
          generate_pdpka({
            km: pdpka4_km,
            user: user,
    ...
    Account.prototype._change_passphrase_compute_login = function(_arg, cb) {
      var eddsa, esc, hmac_pwh, hostname, login_session_b64, pdpka4, pdpka4_km, pdpka5, pdpka5_km, pwh, uid, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      hostname = _arg.hostname, uid = _arg.uid, login_session_b64 = _arg.login_session_b64, pwh = _arg.pwh, eddsa = _arg.eddsa;
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/home/michal/libweb/src/hilevel/account.iced",
            funcname: "Account._change_passphrase_compute_login"
          });
          secret32_to_signing_km({
            secret32: pwh
          }, esc(__iced_deferrals.defer({
        ...
        return function() {
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              return cb(null, hmac_pwh, pdpka4, pdpka5);
            });
          });
        };
      })(this));
    ...
    Account.prototype.get_unlocked_private_pgp_key = function(_arg, cb) {
      var bundle, err, esc, kid, no_check_keys, passphrase, pw, res, sk, time_travel, tsenc, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      pw = _arg.pw, kid = _arg.kid, no_check_keys = _arg.no_check_keys, time_travel = _arg.time_travel;
    ...
    Account.prototype.export_my_private_key = function(_arg, cb) {
      var armored_private, err, esc, kid, no_check_keys, passphrase, pw, sk, time_travel, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      kid = _arg.kid, pw = _arg.pw, no_check_keys = _arg.no_check_keys, time_travel = _arg.time_travel;
    ...
    Account.prototype._change_passphrase_derive_passphrase_components = function(_arg, cb) {
      var C, eddsa, esc, key, keys, km, lks_client_half, passphrase, pwh, salt, tsenc, _, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        ...
        return function() {
          var _ref;
          km = keys.extra;
          _ref = bufsplit(km, [C.pwh.derived_key_bytes, C.nacl.eddsa_secret_key_bytes, C.nacl.dh_secret_key_bytes, C.device.lks_client_half_bytes]), pwh = _ref[0], eddsa = _ref[1], _ = _ref[2], lks_client_half = _ref[3];
          return cb(null, {
            tsenc: tsenc,
            pwh: pwh,
    ...
    Account.prototype.reset_passphrase = function(_arg, cb) {
      var esc, hostname, l, new_pp, params, pdpka4_kid, pdpka5_kid, pwh, res, salt, secret32_eddsa, uid, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      new_pp = _arg.new_pp, uid = _arg.uid, hostname = _arg.hostname, l = _arg.l;
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/home/michal/libweb/src/hilevel/account.iced",
            funcname: "Account.reset_passphrase"
          });
          _this.config.request({
            method: "GET",
            endpoint: 'getsalt',
    ...
    Account.prototype.change_passphrase = function(_arg, cb) {
      var esc, exclude_kids, hmac_pwh, hostname, lks_mask, lksch, login_session_b64, me, new_pp, new_ppc, old_pdpka4, old_pdpka5, old_pp, old_ppc, params, pdpka5_kid, private_keys, res, salt, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      old_pp = _arg.old_pp, new_pp = _arg.new_pp, exclude_kids = _arg.exclude_kids, hostname = _arg.hostname;
      old_ppc = new_ppc = null;
      esc = make_esc(cb, "change_passphrase");
      params = {
        make_login_session: 1
      };
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
        ...
        return function() {
          (function(__iced_k) {
            var _ref, _ref1;
            if (!(((me = res != null ? (_ref = res.body) != null ? _ref.me : void 0 : void 0) != null) && ((login_session_b64 = res != null ? (_ref1 = res.body) != null ? _ref1.login_session : void 0 : void 0) != null))) {
              (function(__iced_k) {
                __iced_deferrals = new iced.Deferrals(__iced_k, {
                  parent: ___iced_passed_deferral,
                  filename: "/home/michal/libweb/src/hilevel/account.iced",
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  _this._change_passphrase_compute_login({
                    uid: me.id,
                    login_session_b64: login_session_b64,
                    pwh: old_ppc.pwh,
                    eddsa: old_ppc.eddsa,
                    ...
                    assign_fn: (function() {
                      return function() {
                        hmac_pwh = arguments[0];
                        old_pdpka4 = arguments[1];
                        return old_pdpka5 = arguments[2];
                      };
                    })(),
                    lineno: 363
                  })));
  ...
  exports.secret32_to_signing_km = secret32_to_signing_km = function(_arg, cb) {
    var err, km, ret, secret32, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
  ...
  to_user = function(_arg) {
    var email_or_username, uid, user;
    email_or_username = _arg.email_or_username, uid = _arg.uid;
    user = {};
    if (uid != null) {
      user.uid = uid;
    }
