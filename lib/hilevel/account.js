...
(function() {
  ...
  exports.Account = Account = (function() {
    ...
    Account.prototype._change_passphrase_reencrypt_pgp_private_keys = function(_arg, cb) {
      var bundle, esc, exclude_kids, kid, km, me, new_ppc, old_ppc, output, outputs, passphrase_generation, tsenc, ___iced_passed_deferral, __iced_deferrals, __iced_k, _next;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
