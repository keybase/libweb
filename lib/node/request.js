...
(function() {
  var Request, iced, request, urlmod, __iced_k, __iced_k_noop,
  ...
  exports.Request = Request = (function(_super) {
    ...
    function Request(_arg) {
      var get_csrf_token;
      get_csrf_token = _arg.get_csrf_token;
    ...
    Request.prototype.request = function(inargs, cb) {
      var err, headers, method, req_args, res, uri, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/max/src/keybase/libweb/src/node/request.iced",
            funcname: "Request.request"
          });
          request(req_args, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                err = arguments[0];
        ...
        return function() {
          return _this._handle_response({
            err: err,
            inargs: inargs,
            body: typeof res !== "undefined" && res !== null ? res.body : void 0,
